...
Mesh::Mesh(vector<Vertex> &vertices, vector<GLuint> &indices, vector<ModelTexures> &textures, bool loadTangents)
{
...
void Mesh::setupMesh()
{
	...
	// Vertex Normals
	// A preprocessor directive called offsetof(s,m) that takes as its first argument a struct and as its 
	// second argument a variable name of the struct. The macro returns the byte offset of that variable from the start of the struct. 
